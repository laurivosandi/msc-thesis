...
The workflow of the prototype is split into
bootstrap and live stages as shown in
Figure~\ref{fig:butterknife-workflow}.

A template of computer's
is prepared in a Linux Container
...
Using Debian, Ubuntu, Gentoo and Buildroot were evaluated as
provisioning utility operating system.
...
Buildroot was eventually used to generate an (<15MB)
all-in-one PXE-bootable image as well as ISO image
which can be dumped on a USB memory stick.
...
was generally satisfied with the delivery.
...
utility which can be used to checksum a directory.
